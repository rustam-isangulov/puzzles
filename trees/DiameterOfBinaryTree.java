...
public class DiameterOfBinaryTree {
	...
	System.out.println("DimaterOfBinaryTree is starting...");
	...
	System.out.println();
	System.out.println("DiameterOfBinaryTree has finished.");
    }


    public static void test(Integer[] nodes) {
	// basic check
	if (null == nodes && null == nodes[0]) {
	    return;
	}

	// turn array into a binary tree
	var tree = deserialiseTree(nodes);
	...
	if (null != root) {
	    ...
	    int descendantsD = Math.max(diameterOfBinaryTree(root.left)
    ...
    static TreeNode deserialiseTree(Integer[] nodes) {
